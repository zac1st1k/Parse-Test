...
//    cell.detailTextLabel.text = loginCredentials[@"password"];
    ...
    cell.textLabel.text = [[self.credentials objectAtIndex:indexPath.row] valueForKey:@"name"];
    cell.detailTextLabel.text = [[self.credentials objectAtIndex:indexPath.row] valueForKey:@"password"];
    return cell;
}
